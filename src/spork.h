...
static const int64_t SPORK_5_INSTANTSEND_MAX_VALUE_DEFAULT              = 5000;         // 5000 FXC
static const int64_t SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT_DEFAULT     = 1516795200;	// OFF
