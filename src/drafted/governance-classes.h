 ...
 *
 *   // network
 *   CFxcNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.fexchange.market/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CFxcNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: FxcNetwork
// //   -- signature requirements : Key1(User)
// class CFxcNetworkVariable : public CGovernanceObject
// {
// private:
