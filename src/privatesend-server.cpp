...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Fxc related functionality
...
/*
    ...
    allow endless transaction that would bloat Fxc and make it unusable. To
