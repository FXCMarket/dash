    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Fxc") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  fxc-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Fxc in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 FXC, 0.1 FXC, 1 FXC and 10 FXC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://fexchange.atlassian.net/wiki/display/DOC/PrivateSend\">https://fexchange.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
