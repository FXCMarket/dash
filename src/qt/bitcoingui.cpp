...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Fxc address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fxc: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Fxc"), this);
    aboutAction->setStatusTip(tr("Show information about Fxc"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Fxc"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Fxc addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Fxc addresses"));
    ...
    openAction->setStatusTip(tr("Open a fxc: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Fxc help message to get a list with possible Fxc command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Fxc client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Fxc network", "", count));
    } else {
...
{
    QString strTitle = tr("Fxc"); // default title
