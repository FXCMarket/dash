    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("FXC-light"), QVariant("light"));
    ui->theme->addItem(QString("FXC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("FXC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("FXC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("FXC-traditional"), QVariant("trad"));
