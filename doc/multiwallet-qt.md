...
Only requiring some minor changes is fxc.cpp.
...
Changes to fxc.cpp
----------------------
fxc.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
