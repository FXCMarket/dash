...
Fxc is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 19701.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 19700 for connections and services them.
...
However, in open source software such as Fxc, where everyone uses
...
pay attention to for reviewers of Fxc code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Fxc uses tinyformat, which is type safe. Leave them out to avoid confusion
