...
This mechanism has been integrated into Bitcore-Node-Fxc which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/fexchange/insight-api-fxc#web-socket-api](https://github.com/fexchange/insight-api-fxc#web-socket-api)
* API: [https://github.com/fexchange/insight-api-fxc#instantsend-transactions](https://github.com/fexchange/insight-api-fxc#instantsend-transactions)
...
By default, the Fxc daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Fxc daemon:
